...
export const portfolios = [
  ...
  },
  {
    ...
    desc: "Blockchain site to send and receive payments using MetaMask (They have to log in too)<br /> skills: <b>React.js, Tailwind CSS, Solidity, Styled-Components, Zustand</b>",
  ...
  },
  {
    ...
    desc: "E-commerce site where users can order for products from different sellers and have it delivered to them<br /> skills: <b>HTML, CSS, JavaScript (JQuery), PHP, MYSQL</b>",
    link: "/",
    isAvailable: false,
  },
];
